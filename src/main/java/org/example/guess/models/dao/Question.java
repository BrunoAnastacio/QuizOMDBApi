<<<<<<<< HEAD:src/main/java/org/example/guess/models/beans/Question.java
...
>>>>>>>> 784474c (Iniciada implementação de PlayerBean):src/main/java/org/example/guess/models/dao/Question.java
